...
1. Explain what a token is used for.
   it provides authentication and authorization feautures to routes that are protected within the server
2. What steps can you take in your web apps to keep your data secure?
   always make sure the user receives a token in return to access private routed locations
3. Describe how web servers work.
   web server processes incoming network requests over http protocols. Main functions of web server is to store , process and deliver web pages to clients
